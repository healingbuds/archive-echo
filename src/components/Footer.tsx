      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 items-start">
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-[10px] sm:text-xs tracking-[0.25em] sm:tracking-[0.3em] text-foreground/50 uppercase mb-4 sm:mb-6">Pages</h4>
            <div className="flex flex-wrap gap-x-4 sm:gap-x-6 gap-y-2 sm:gap-y-3 justify-center sm:justify-start">
              {pageLinks.slice(0, 5).map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className="text-[10px] sm:text-xs tracking-wider text-foreground/80 hover:text-primary transition-colors uppercase"
                >
                  {link.label}
                </Link>
              ))}
            </div>
            <div className="flex flex-wrap gap-x-4 sm:gap-x-6 gap-y-2 sm:gap-y-3 justify-center sm:justify-start mt-3 sm:mt-4">
          ...
          <div className="text-center sm:text-left lg:text-right sm:col-span-2 lg:col-span-1">
            <h4 className="text-[10px] sm:text-xs tracking-[0.25em] sm:tracking-[0.3em] text-foreground/50 uppercase mb-4 sm:mb-6">Socials</h4>
            <div className="flex items-center gap-3 sm:gap-4 justify-center sm:justify-start lg:justify-end">
              <a 
            ...
            <div className="flex items-center gap-3 sm:gap-4 justify-center sm:justify-start lg:justify-end mt-3 sm:mt-4">
              <a 
        ...
        {/* Bottom Section */}
        <div className="mt-10 sm:mt-12 md:mt-16 pt-6 sm:pt-8 border-t border-border/20 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          <p className="text-[10px] sm:text-xs text-foreground/40 tracking-wider">
            2024 © DR. GREEN NFT
          </p>
          <p className="text-[10px] sm:text-xs text-foreground/40 tracking-wider text-center sm:text-right">
